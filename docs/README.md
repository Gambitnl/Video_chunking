...
- **[archive/BUG_HUNT_TODO.md](./archive/BUG_HUNT_TODO.md)**: Detailed bug hunt task list with context, issues, and reasoning notes (updated with Process Session progress tracking status on 2025-11-20 and CampaignChatChain integration coverage on 2025-11-21).
