...
- [~] BUG-20251102-01: CampaignChatClient.ask - Add integration tests for full RAG pipeline (Agent: Claude Sonnet 4.5, Started: 2025-11-20 21:24 UTC) → BUG_HUNT_TODO.md:9
