...
- [~] BUG-20251103-019: Live Session - Non-functional placeholder tab (Agent: Claude, Started: 2025-11-06, Files: src/ui/live_session_tab.py, app.py) → BUG_HUNT_TODO.md:367
